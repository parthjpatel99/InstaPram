...
import com.parth8199.instapram.MainActivity.Companion.TAG
...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<MaterialButton>(R.id.btn_change_image).setOnClickListener {
            onLaunchCamera()
        }
        view.findViewById<MaterialButton>(R.id.btn_save).setOnClickListener {
            val description =
                view.findViewById<TextInputEditText>(R.id.et_description).text.toString()
